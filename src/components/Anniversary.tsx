...
const ALL_PHOTOS = [
  ...
  ...Array.from({ length: 36 }, (_, i) => ({
    id: i + 16,
    image: `aventuras/foto${i + 16}.jpeg`,
    title: `Aventura #${String(i + 16).padStart(2, '0')}`,
    tag: `AVENTURA · ${String(i + 16).padStart(2, '0')}`,
...
const FEATURED_COLLAGE: CollageCard[] = [
  ...
  },
  {
    id: 7,
    image: 'aventuras/foto14.jpeg',
    title: 'Perspectiva con Vino Toro',
    place: 'Salinas Grandes',
    hiddenNote: 'Nuestras fotos divertidas nunca fallan: el vino Toro gigante y nosotros dos en el fondo jugando con la cámara.',
    aspect: 'square',
  },
  {
    id: 8,
    image: 'aventuras/foto15.jpeg',
    title: 'Felicidad sin límites',
    place: 'Salinas Grandes',
    hiddenNote: 'Flor corriendo con los brazos abiertos por el salar, transmitiendo esa energía y alegría contagiosa que amo.',
    aspect: 'tall',
  },
];
